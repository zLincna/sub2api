...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	lotteryService := service.NewLotteryService(db, settingRepository)
	authService := service.ProvideAuthServiceWithLottery(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, lotteryService)
	...
	announcementAPIKeyGroupReader := repository.NewAnnouncementAPIKeyGroupReader(client, db)
	announcementService := service.NewAnnouncementService(announcementRepository, announcementReadRepository, userRepository, userSubscriptionRepository, announcementAPIKeyGroupReader)
	...
	handlerCarpoolHandler := handler.NewCarpoolHandler(carpoolService)
