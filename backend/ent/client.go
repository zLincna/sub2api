...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.BatchImageJob, c.CarpoolNoticeVersion, c.CarpoolParticipant,
		c.CarpoolSession, c.CarpoolVehicleType, c.CarpoolVoucher, c.ChannelMonitor,
...
type (
	hooks struct {
		...
		CarpoolNoticeVersion, CarpoolParticipant, CarpoolSession, CarpoolVehicleType,
		CarpoolVoucher, ChannelMonitor, ChannelMonitorDailyRollup,
