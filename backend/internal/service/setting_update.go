...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyAliyunSMSRegistrationMode] = normalizeAliyunSMSRegistrationMode(settings.AliyunSMSRegistrationMode)
	...
	updates[SettingKeyAliyunSMSTemplateParamKey] = strings.TrimSpace(settings.AliyunSMSTemplateParamKey)
	...
	updates[SettingKeyAliyunSMSValidTimeSeconds] = strconv.Itoa(settings.AliyunSMSValidTimeSeconds)
	updates[SettingKeyAliyunSMSIntervalSeconds] = strconv.Itoa(settings.AliyunSMSIntervalSeconds)
