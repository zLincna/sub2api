export default {
  ...
  auth: {
    ...
    phoneVerificationCodeHint: '请输入发送到手机号的6位验证码',
    phoneCodeSentSuccess: '短信验证码已发送，请查收。',
    passwordLabel: '密码',
  ...
  keys: {
    ...
    chatIntegrations: '对接',
    chatIntegrationSentToFluent: 'API 密钥已发送至流畅阅读。',
    chatIntegrationFluentNotDetected: '未检测到流畅阅读扩展，请确认扩展已安装并启用。',
    chatIntegrationInvalid: '对接链接无效，请联系管理员。',
    chatIntegrationOpenFailed: '无法打开对接链接，请确认客户端已安装或协议处理程序已注册。',
    enable: '启用',
    disable: '禁用',
    nameLabel: '名称',
  ...
  lottery: {
    ...
    time: '时间',
    customPrize: '自定义奖品',
    noPrizeConfigured: '暂无奖品',
    drawSuccess: '中奖：{name}，{award}',
    sourceTypes: {
      daily_login: '每日登录',
      spend: '消费赠送',
      recharge: '充值赠送'
  ...
  admin: {
    ...
    lottery: {
      ...
      enabled: '启用',
      enabledHint: '关闭后用户无法进入抽奖或消耗次数',
      buttonEnabled: '显示顶部入口',
      buttonEnabledHint: '控制用户端顶部动画按钮是否展示',
      timezone: '规则时区',
      ruleText: '规则说明',
      loginRule: '每日登录送次数',
      spendRule: '消费送次数',
      ...
      prizeName: '奖品名称',
      prizeContent: '奖品内容',
      prizeContentPlaceholder: '例如：现金5元、免费蹬一天（联系管理员调整专属倍率）',
      prizeContentHint: '余额奖品会按金额自动入账；非现金奖品金额可填 0，并在内容里写清楚兑现方式。',
      amount: '中奖余额',
      probability: '概率权重',
      stock: '库存（日/总）',
      dailyStock: '每日库存',
      ...
      sortOrder: '排序',
      unlimited: '不限',
      emptyPrizes: '暂无奖品，请先添加奖品',
      recordsTitle: '中奖记录',
      recordsDesc: '支持按用户ID、邮箱/账号关键词、来源和时间范围查询。',
      emptyRecords: '暂无中奖记录',
      source: '来源',
      user: '用户',
      userId: '用户ID',
      userKeyword: '账号/邮箱',
      userKeywordPlaceholder: '输入邮箱、账号或用户ID',
      startTime: '开始时间',
      endTime: '结束时间',
    ...
    settings: {
      ...
      payment: {
        ...
        balanceBonusRules: '充值满赠规则',
        balanceBonusRulesHint: '按用户输入的充值金额命中最高一档，赠送余额会计入到账金额，不改变实际支付金额。',
        addBonusRule: '添加规则',
        noBonusRules: '暂无满赠规则',
        bonusThreshold: '满多少',
        bonusAmount: '赠送余额',
        bonusLabel: '展示文案',
        bonusLabelPlaceholder: '如：满 100 送 10',
        balanceBonusRulesPreview: '预览：充值 {amount} 时赠送 {bonus}',
