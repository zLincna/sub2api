export default {
  ...
  auth: {
    ...
    phoneVerificationCode: 'SMS Code',
    phoneVerificationCodeHint: 'Enter the 6-digit code sent to your phone',
    phoneCodeSentSuccess: 'SMS verification code sent.',
  ...
  keys: {
    ...
    chatIntegrationSentToFluent: 'API key sent to FluentRead.',
    chatIntegrationFluentNotDetected: 'FluentRead extension not detected. Please ensure it is installed and active.',
    chatIntegrationInvalid: 'Invalid integration link. Please contact your administrator.',
    chatIntegrationOpenFailed: 'Failed to open the integration link. Please ensure the client is installed or the protocol handler is registered.',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
  ...
  lottery: {
    ...
    noPrizeConfigured: 'No Prize',
    drawSuccess: 'Won {name}, {award}',
    sourceTypes: {
  ...
  admin: {
    ...
    lottery: {
      ...
      enabled: 'Enabled',
      enabledHint: 'When off, users cannot open lottery or consume chances',
      buttonEnabled: 'Show Header Entry',
      buttonEnabledHint: 'Controls whether the animated user header button is visible',
      ...
      thresholdChances: 'Bonus Chances',
      addTier: 'Add Tier',
      emptyTiers: 'No tiers yet. Add a tier to configure grants',
      ...
      prizeContentPlaceholder: 'e.g. $5 cash, one free day, contact admin for custom rate',
      prizeContentHint: 'Balance prizes are credited by amount. For non-balance prizes, set amount to 0 and describe fulfillment here.',
      ...
      recordsDesc: 'Filter by user ID, email/account keyword, source, and time range.',
      emptyRecords: 'No draw records yet',
      source: 'Source',
      user: 'User',
      userId: 'User ID',
      userKeyword: 'Account / Email',
      userKeywordPlaceholder: 'Email, account, or user ID',
      startTime: 'Start Time',
      endTime: 'End Time',
      recordTotal: '{total} records, page {page}/{pages}',
    ...
    settings: {
      ...
      payment: {
        ...
        balanceBonusRules: 'Top-up Bonus Rules',
        balanceBonusRulesHint: 'The highest matching tier is applied based on the entered top-up amount. The bonus is credited to balance and does not change the paid amount.',
        addBonusRule: 'Add Rule',
        noBonusRules: 'No bonus rules yet',
        bonusThreshold: 'Minimum top-up',
        bonusAmount: 'Bonus balance',
        bonusLabel: 'Display label',
        bonusLabelPlaceholder: 'e.g. Top up 100, get 10',
        balanceBonusRulesPreview: 'Preview: top up {amount}, bonus {bonus}',
